...
/**
 * Máscara de CNPJ aplicada durante a digitação.
 *
 * Diferente de formatarCNPJ, que espera o documento completo, esta função
 * formata o que já foi digitado — sem isso o campo só ficaria legível ao
 * chegar no décimo quarto dígito.
 */
export function formatarCNPJParcial(valor: string): string {
